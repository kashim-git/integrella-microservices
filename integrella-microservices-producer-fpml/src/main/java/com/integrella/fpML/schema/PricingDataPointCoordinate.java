 ...
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fpml.org/FpML-5/master}PricingStructureIndex.model" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
public class PricingDataPointCoordinate {
    ...
    @XmlElementRefs({
        ...
        @XmlElementRef(name = "expiration", namespace = "http://www.fpml.org/FpML-5/master", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "term", namespace = "http://www.fpml.org/FpML-5/master", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "generic", namespace = "http://www.fpml.org/FpML-5/master", type = JAXBElement.class, required = false)
    })
