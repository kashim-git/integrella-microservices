 ...
 *       &lt;attribute name="serviceStatusScheme" type="{http://www.fpml.org/FpML-5/master}NonEmptyURI" default="http://www.fpml.org/coding-scheme/service-status" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
public class ServiceStatus {
    ...
    @XmlAttribute(name = "serviceStatusScheme")
    ...
    public String getServiceStatusScheme() {
        if (serviceStatusScheme == null) {
            return "http://www.fpml.org/coding-scheme/service-status";
        } else {
     ...
     *     
     */
    public void setServiceStatusScheme(String value) {
        this.serviceStatusScheme = value;
    }
