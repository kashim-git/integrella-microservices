 ...
 *       &lt;attribute name="reasonCodeScheme" type="{http://www.fpml.org/FpML-5/master}NonEmptyURI" default="http://www.fpml.org/coding-scheme/reason-code" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
public class ReasonCode {
    ...
    @XmlAttribute(name = "reasonCodeScheme")
    ...
    public String getReasonCodeScheme() {
        if (reasonCodeScheme == null) {
            return "http://www.fpml.org/coding-scheme/reason-code";
        } else {
     ...
     *     
     */
    public void setReasonCodeScheme(String value) {
        this.reasonCodeScheme = value;
    }
