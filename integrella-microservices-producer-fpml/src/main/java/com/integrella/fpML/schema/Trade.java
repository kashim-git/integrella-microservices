 ...
 *       &lt;sequence>
 *         &lt;element name="tradeHeader" type="{http://www.fpml.org/FpML-5/master}TradeHeader" minOccurs="0"/>
 *         &lt;element ref="{http://www.fpml.org/FpML-5/master}product" minOccurs="0"/>
 *         &lt;element name="otherPartyPayment" type="{http://www.fpml.org/FpML-5/master}Payment" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="brokerPartyReference" type="{http://www.fpml.org/FpML-5/master}PartyReference" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;group ref="{http://www.fpml.org/FpML-5/master}CalculationAgent.model"/>
 *         &lt;element name="determiningParty" type="{http://www.fpml.org/FpML-5/master}PartyReference" maxOccurs="2" minOccurs="0"/>
 *         &lt;element name="barrierDeterminationAgent" type="{http://www.fpml.org/FpML-5/master}PartyReference" minOccurs="0"/>
 *         &lt;element name="hedgingParty" type="{http://www.fpml.org/FpML-5/master}PartyReference" maxOccurs="2" minOccurs="0"/>
 *         &lt;element name="collateral" type="{http://www.fpml.org/FpML-5/master}Collateral" minOccurs="0"/>
 *         &lt;element name="documentation" type="{http://www.fpml.org/FpML-5/master}Documentation" minOccurs="0"/>
 *         &lt;element name="governingLaw" type="{http://www.fpml.org/FpML-5/master}GoverningLaw" minOccurs="0"/>
 *         &lt;element name="allocations" type="{http://www.fpml.org/FpML-5/master}Allocations" maxOccurs="2" minOccurs="0"/>
