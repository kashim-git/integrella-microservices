 ...
 * 
 * <p>Java class for StubFloatingRate complex type.
 * 
 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://www.fpml.org/FpML-5/master}Rate">
 *       &lt;sequence>
 *         &lt;group ref="{http://www.fpml.org/FpML-5/master}StubFloatingRateIndex.model"/>
 *         &lt;element name="floatingRateMultiplierSchedule" type="{http://www.fpml.org/FpML-5/master}Schedule" minOccurs="0"/>
 *         &lt;element name="spreadSchedule" type="{http://www.fpml.org/FpML-5/master}SpreadSchedule" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="rateTreatment" type="{http://www.fpml.org/FpML-5/master}RateTreatmentEnum" minOccurs="0"/>
 *         &lt;element name="capRateSchedule" type="{http://www.fpml.org/FpML-5/master}StrikeSchedule" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="floorRateSchedule" type="{http://www.fpml.org/FpML-5/master}StrikeSchedule" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="capFloorStraddle" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "StubFloatingRate", propOrder = {
    "floatingRateIndex",
    "indexTenor",
    ...
    extends Rate
{
    ...
    protected Boolean capFloorStraddle;
    ...
    /**
     * Gets the value of the capFloorStraddle property.
     * 
     * @return
     *     possible object is
     *     {@link Boolean }
     *     
     */
    public Boolean isCapFloorStraddle() {
        return capFloorStraddle;
    }

    /**
     * Sets the value of the capFloorStraddle property.
     * 
     * @param value
     *     allowed object is
     *     {@link Boolean }
     *     
     */
    public void setCapFloorStraddle(Boolean value) {
        this.capFloorStraddle = value;
    }
