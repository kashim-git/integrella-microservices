 ...
 * 
 * <p>Java class for CommoditySettlementPeriodsNotionalQuantitySchedule complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CommoditySettlementPeriodsNotionalQuantitySchedule">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="settlementPeriodsNotionalQuantityStep" type="{http://www.fpml.org/FpML-5/master}CommodityNotionalQuantity" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "CommoditySettlementPeriodsNotionalQuantitySchedule", propOrder = {
...
public class CommoditySettlementPeriodsNotionalQuantitySchedule {
    ...
    protected List<CommodityNotionalQuantity> settlementPeriodsNotionalQuantityStep;
     ...
     * This is why there is not a <CODE>set</CODE> method for the settlementPeriodsNotionalQuantityStep property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSettlementPeriodsNotionalQuantityStep().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<CommodityNotionalQuantity> getSettlementPeriodsNotionalQuantityStep() {
        if (settlementPeriodsNotionalQuantityStep == null) {
            settlementPeriodsNotionalQuantityStep = new ArrayList<CommodityNotionalQuantity>();
        }
