 ...
 *         &lt;element name="dividendEntitlement" type="{http://www.fpml.org/FpML-5/master}DividendEntitlementEnum" minOccurs="0"/>
 *         &lt;element name="dividendAmount" type="{http://www.fpml.org/FpML-5/master}DividendAmountTypeEnum" minOccurs="0"/>
 *         &lt;element name="dividendPaymentDate" type="{http://www.fpml.org/FpML-5/master}DividendPaymentDate" minOccurs="0"/>
 *         &lt;choice minOccurs="0">
 *           &lt;sequence>
 *             &lt;element name="dividendPeriodEffectiveDate" type="{http://www.fpml.org/FpML-5/master}DateReference" minOccurs="0"/>
 *             &lt;element name="dividendPeriodEndDate" type="{http://www.fpml.org/FpML-5/master}DateReference" minOccurs="0"/>
 *           &lt;/sequence>
 *           &lt;element name="dividendPeriod" type="{http://www.fpml.org/FpML-5/master}DividendPeriodEnum"/>
 *         &lt;/choice>
 *         &lt;element name="extraOrdinaryDividends" type="{http://www.fpml.org/FpML-5/master}PartyReference" minOccurs="0"/>
 *         &lt;element name="excessDividendAmount" type="{http://www.fpml.org/FpML-5/master}DividendAmountTypeEnum" minOccurs="0"/>
 *         &lt;group ref="{http://www.fpml.org/FpML-5/master}CurrencyAndDeterminationMethod.model" minOccurs="0"/>
 *         &lt;element name="dividendFxTriggerDate" type="{http://www.fpml.org/FpML-5/master}DividendPaymentDate" minOccurs="0"/>
 *         &lt;element name="interestAccrualsMethod" type="{http://www.fpml.org/FpML-5/master}InterestAccrualsCompoundingMethod" minOccurs="0"/>
 *         &lt;element name="numberOfIndexUnits" type="{http://www.fpml.org/FpML-5/master}NonNegativeDecimal" minOccurs="0"/>
 *         &lt;group ref="{http://www.fpml.org/FpML-5/master}DeclaredCashAndCashEquivalentDividendPercentage.model"/>
 *         &lt;element name="nonCashDividendTreatment" type="{http://www.fpml.org/FpML-5/master}NonCashDividendTreatmentEnum" minOccurs="0"/>
 *         &lt;element name="dividendComposition" type="{http://www.fpml.org/FpML-5/master}DividendCompositionEnum" minOccurs="0"/>
