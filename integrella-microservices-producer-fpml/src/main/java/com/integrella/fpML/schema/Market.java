 ...
 *         &lt;element name="benchmarkQuotes" type="{http://www.fpml.org/FpML-5/master}QuotedAssetSet" minOccurs="0"/>
 *         &lt;element ref="{http://www.fpml.org/FpML-5/master}pricingStructure" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element ref="{http://www.fpml.org/FpML-5/master}pricingStructureValuation" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="benchmarkPricingMethod" type="{http://www.fpml.org/FpML-5/master}PricingMethod" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class Market {
    ...
    @XmlElementRef(name = "pricingStructure", namespace = "http://www.fpml.org/FpML-5/master", type = JAXBElement.class, required = false)
    protected List<JAXBElement<? extends PricingStructure>> pricingStructure;
    @XmlElementRef(name = "pricingStructureValuation", namespace = "http://www.fpml.org/FpML-5/master", type = JAXBElement.class, required = false)
