 ...
 *       &lt;sequence>
 *         &lt;element name="affectedTransactions" type="{http://www.fpml.org/FpML-5/master}AffectedTransactions" minOccurs="0"/>
 *         &lt;element name="referenceEntity" type="{http://www.fpml.org/FpML-5/master}LegalEntity" minOccurs="0"/>
 *         &lt;element ref="{http://www.fpml.org/FpML-5/master}creditEvent" minOccurs="0"/>
 *         &lt;element name="publiclyAvailableInformation" type="{http://www.fpml.org/FpML-5/master}Resource" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="notifyingPartyReference" type="{http://www.fpml.org/FpML-5/master}PartyReference" minOccurs="0"/>
 *         &lt;element name="notifiedPartyReference" type="{http://www.fpml.org/FpML-5/master}PartyReference" minOccurs="0"/>
...
public class CreditEventNoticeDocument {
    ...
    @XmlElementRef(name = "creditEvent", namespace = "http://www.fpml.org/FpML-5/master", type = JAXBElement.class, required = false)
