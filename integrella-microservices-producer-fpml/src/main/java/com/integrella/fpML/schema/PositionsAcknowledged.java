 ...
 *       &lt;sequence>
 *         &lt;element name="portfolio" type="{http://www.fpml.org/FpML-5/master}PortfolioDefinition" minOccurs="0"/>
 *         &lt;choice maxOccurs="unbounded" minOccurs="0">
 *           &lt;element name="definedPosition" type="{http://www.fpml.org/FpML-5/master}PositionReference"/>
 *           &lt;element name="removedPosition" type="{http://www.fpml.org/FpML-5/master}PositionReference"/>
 *           &lt;element name="unprocessedPosition" type="{http://www.fpml.org/FpML-5/master}UnprocessedPosition"/>
 *         &lt;/choice>
    ...
    extends ResponseMessage
{
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "unprocessedPosition", namespace = "http://www.fpml.org/FpML-5/master", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "definedPosition", namespace = "http://www.fpml.org/FpML-5/master", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "removedPosition", namespace = "http://www.fpml.org/FpML-5/master", type = JAXBElement.class, required = false)
    })
