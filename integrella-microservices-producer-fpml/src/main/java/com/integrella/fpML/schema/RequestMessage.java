 ...
 *       &lt;sequence>
 *         &lt;element name="header" type="{http://www.fpml.org/FpML-5/master}RequestMessageHeader" minOccurs="0"/>
...
@XmlSeeAlso({
    PositionsAsserted.class,
    RequestPortfolio.class,
    NonCorrectableRequestMessage.class,
    CorrectableRequestMessage2 .class,
