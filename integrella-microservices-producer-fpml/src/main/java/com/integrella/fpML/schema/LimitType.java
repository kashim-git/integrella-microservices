 ...
 *       &lt;attribute name="creditLimitTypeScheme" type="{http://www.fpml.org/FpML-5/master}NonEmptyURI" default="http://www.fpml.org/coding-scheme/credit-limit-type" />
 *     &lt;/extension>
 *   &lt;/simpleContent>
 * &lt;/complexType>
 * </pre>
...
public class LimitType {
    ...
    @XmlAttribute(name = "creditLimitTypeScheme")
    ...
    public String getCreditLimitTypeScheme() {
        if (creditLimitTypeScheme == null) {
            return "http://www.fpml.org/coding-scheme/credit-limit-type";
        } else {
     ...
     *     
     */
    public void setCreditLimitTypeScheme(String value) {
        this.creditLimitTypeScheme = value;
    }
