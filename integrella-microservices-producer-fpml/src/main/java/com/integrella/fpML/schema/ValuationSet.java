 ...
 *       &lt;sequence>
 *         &lt;element name="name" type="{http://www.fpml.org/FpML-5/master}String" minOccurs="0"/>
 *         &lt;element name="valuationScenario" type="{http://www.fpml.org/FpML-5/master}ValuationScenario" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="valuationScenarioReference" type="{http://www.fpml.org/FpML-5/master}ValuationScenarioReference" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="baseParty" type="{http://www.fpml.org/FpML-5/master}PartyReference" minOccurs="0"/>
 *         &lt;element name="quotationCharacteristics" type="{http://www.fpml.org/FpML-5/master}QuotationCharacteristics" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="sensitivitySetDefinition" type="{http://www.fpml.org/FpML-5/master}SensitivitySetDefinition" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="detail" type="{http://www.fpml.org/FpML-5/master}ValuationSetDetail" minOccurs="0"/>
 *         &lt;element name="assetValuation" type="{http://www.fpml.org/FpML-5/master}AssetValuation" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
