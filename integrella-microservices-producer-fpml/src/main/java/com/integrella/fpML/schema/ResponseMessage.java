 ...
 *       &lt;sequence>
 *         &lt;element name="header" type="{http://www.fpml.org/FpML-5/master}ResponseMessageHeader" minOccurs="0"/>
 *         &lt;group ref="{http://www.fpml.org/FpML-5/master}Validation.model"/>
 *         &lt;group ref="{http://www.fpml.org/FpML-5/master}CorrelationAndOptionalSequence.model"/>
...
@XmlSeeAlso({
    ...
    SubstituteReturnConfirmationStatus.class,
    MarginQuoteAcknowledgement.class,
    ConfirmationStatus.class,
    MarginCallStatus.class,
    MarginQuoteConfirmed.class,
    AllocationApproved.class,
    ConfirmationAgreed.class,
    InterestStatus.class,
    CollateralProposalStatus.class,
    EventStatusResponse.class,
    NettedTradeCashflowsMatchResult.class,
    PositionsAcknowledged.class,
    RequestCollateralAcceptance.class,
    TradeCashflowsMatchResult.class,
    AllocationRefused.class,
    PositionsMatchResults.class,
    SubstitutionStatus.class,
